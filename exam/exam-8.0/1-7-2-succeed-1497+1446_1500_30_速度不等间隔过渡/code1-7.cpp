...
void Answer::dis_path(int a[100])
{
	for(int i=0;i<100;i++)
		{
			a[i]=path[i];
...
//***********************************************************
	...
	int car_speed_4_6=0,car_speed_8=0,car_speed_10=0,car_speed_12=0,car_speed_14=0,car_speed_16=0;//某个速度车辆的个数
	int flag_speed=0;//某速度的车辆个数是奇还是偶
	int span=0;
	...
	for(int j=1;Car_group[j].dis_num(1)!=0;j++)
	{
		...
		time_step=int(j/1500);
		span=3;
		//最后出发的车提前
		//{待写}
		//路短的先走
		//{Car_group[j].dis_num(6)}
		//快车慢车过渡，速度16-14-12-10-8-(6-4-6)-8-10-12-14
		//                  0  -1- 3- 6-10 -15-  20-24-27-29
		if(time_step==0)//第一批车
		{
		...
		{
			switch (Car_group[j].dis_num(4))
			{
				case 4:
					car_speed_4_6=car_speed_4_6+1;
					outf<<(50+15+span*(10*time_step));
					break;
				case 6:
					car_speed_4_6=car_speed_4_6+1;
					outf<<(50+15+span*(10*time_step));
					break;
				case 8:
					car_speed_8=car_speed_8+1;
					flag_speed=car_speed_8%2;
					if(flag_speed==1)
					{
						outf<<(50+10+span*(10*time_step));
					}
					else
					{
						outf<<(50+20+span*(10*time_step));
					}
					break;
				case 10:
					car_speed_10=car_speed_10+1;
					flag_speed=car_speed_10%2;
					if(flag_speed==1)
					{
						outf<<(50+6+span*(10*time_step));
					}
					else
					{
						outf<<(50+24+span*(10*time_step));
					}
					break;
				case 12:
					car_speed_12=car_speed_12+1;
					flag_speed=car_speed_12%2;
					if(flag_speed==1)
					{
						outf<<(50+3+span*(10*time_step));
					}
					else
					{
						outf<<(50+27+span*(10*time_step));
					}
					break;
				case 14:
					car_speed_14=car_speed_14+1;
					flag_speed=car_speed_14%2;
					if(flag_speed==1)
					{
						outf<<(50+1+span*(10*time_step));
					}
					else
					{
						outf<<(50+29+span*(10*time_step));
					}
					break;
				case 16:
					car_speed_16=car_speed_16+1;
					outf<<(50+0+span*(10*time_step));
					break;
				default :
					//return -1;
					cout<<"error"<<endl;
