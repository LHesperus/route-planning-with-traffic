		...
		else
		{
			switch (Car_group[j].dis_num(4))
			{
				...
				case 8:
					...
					if(flag_speed==1)
					{
						outf<<(50+5+10*time_step);
					}
					else
					{
						outf<<(50+7+10*time_step);
					}
					break;
				case 10:
					...
					if(flag_speed==1)
					{
						outf<<(50+4+10*time_step);
					}
					else
					{
						outf<<(50+8+10*time_step);
					}
					break;
				case 12:
					...
					if(flag_speed==1)
					{
						outf<<(50+3+10*time_step);
					}
					else
					{
						outf<<(50+9+10*time_step);
					}
					break;
				case 14:
					...
					if(flag_speed==1)
					{
						outf<<(50+2+10*time_step);
					}
					else
					{
						outf<<(50+10+10*time_step);
					}
					break;
				case 16:
					car_speed_16=car_speed_16+1;
					outf<<(50+1+10*time_step);
					break;
				default :
					//return -1;
					cout<<"error"<<endl;
