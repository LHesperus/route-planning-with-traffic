		...
		else
		{
			switch (Car_group[j].dis_num(4))
			{
				...
				case 8:
					...
					if(flag_speed==1)
					{
						outf<<(50+span*(4+10*time_step));
					}
					else
					{
						outf<<(50+span*(6+10*time_step));
					}
					break;
				case 10:
					...
					if(flag_speed==1)
					{
						outf<<(50+span*(3+10*time_step));
					}
					else
					{
						outf<<(50+span*(7+10*time_step));
					}
					break;
				case 12:
					...
					if(flag_speed==1)
					{
						outf<<(50+span*(1+10*time_step));
					}
					else
					{
						outf<<(50+span*(8+10*time_step));
					}
					break;
				case 14:
					...
					if(flag_speed==1)
					{
						outf<<(50+span*(2+10*time_step));
					}
					else
					{
						outf<<(50+span*(9+10*time_step));
					}
					break;
				case 16:
					car_speed_16=car_speed_16+1;
					outf<<(50+span*(0+10*time_step));
					break;
				default :
					//return -1;
					cout<<"error"<<endl;
